#Principal Volatility Components - Modified PVC from Miettinen et al. (2019)
# Method PVC
PVC <- function(X, ...) UseMethod("PVC")

# main function for PVC
PVC.default <- function(X, k = 1:12, ordered = FALSE, acfk = NULL, original = TRUE, alpha = 0.05, ...) {
  ...
  U <- .Call("EIGEN", R, PACKAGE = "tsBSS")$vectors
